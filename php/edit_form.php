                    ...
                    <div class="card-body">
                        <form action="submit_form.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="<?php echo $shipping['name']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="description">คำอธิบาย</label>
                                <TEXTAREA name="description" id="description" rows="5" class="form-control"><?php echo $shipping['description']; ?></TEXTAREA>
                            </div>
                            <div class="form-group">
                                <label for="weight">น้ำหนักสูงสุด (กิโลกรัม)</label>
                                <input type="number" name="weight" id="weight" class="form-control" value="<?php echo $shipping['weight']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="size">ขนาดสูงสุด (เซนติเมตร)</label>
                                <input type="number" name="size" id="size" class="form-control" value="<?php echo $shipping['size']; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <TEXTAREA name="termsOfService" id="termsOfService" rows="10" class="form-control"><?php echo $shipping['termsOfService']; ?></TEXTAREA>
                            </div>
                            <div class="form-group">
